...
class nss_plugin_updater
{
	...
	function admin_notice() {
        ...
        echo sprintf(__("<p id='nss_plugin_updater_admin_notice'>License of your plugin <b>".$this->get_plugin_data()->Name."</b> is invalid or incomplete. Please click <a href='".$licensepage."'>here</a> to update your license, or %s one now.</p>", "grassblade"),"<a href='http://www.nextsoftwaresolutions.com/grassblade-xapi-companion/' target='_blank'>".__("buy", "grassblade")."</a>" );			
	}
