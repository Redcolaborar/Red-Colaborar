...
<p>
<?php _e('Currently PageViews Tracking information is sent in the latest TinCan(xAPI) Version. i.e. 1.0.0<br>Please look for GrassBlade Updates if a newer xAPI version is released.','grassblade'); ?>
</p>
</div>
