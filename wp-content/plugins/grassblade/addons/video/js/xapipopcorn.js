(function(ADL){
    ...
    function PopcornVideo(player, comp) {
        var myplayer = player;
        var playerID = (player.video_name != undefined)? player.video_name:player.media.id;
       ...
       // console.log(parseQueryString());
        ...
        function startstuff(launched){
            ...
            stmt["context"] = {"contextActivities":{"parent":[{"id": objectURI}], "grouping":[{"id": objectURI}]}};
            ...
            if (launched){
                ...
                stmt["result"] = {"extensions":{"resumed":resumeTime}}
            }
            report(stmt);
        }
        function attempted() {
            var stmt = {"actor":actor, "object": videoActivity}
            stmt["verb"] = ADL.verbs.attempted;
            var context = {"contextActivities":{"parent":[{"id": objectURI}], "grouping":[{"id": objectURI}]}};
        ...
        function pauseStuff(pauseTime){
            ...
            var stmt = {"actor":actor, 
                    ...
                    "result":{"extensions":{"paused":paused}}}
        ...
        function seekStuff(seekTime){
            ...
            var stmt = {"actor":actor, 
                    ...
                    "object":videoActivity, 
                    "result":{"extensions":{"seeked": seeked}}}
