		...
		function settings_screen( $group_id = NULL ) {
			...
			if ( !empty($group_status) && ( '-1' != $group_status )  ) {
				...
				<div class="bp-learndash-course-activity-checkbox">
					...
					<input type="checkbox" name="user_topic_end" value="true" <?php echo $this->bp_is_checked( 'user_topic_end', $bp_learndash_course_activity ); ?> ><?php printf( __('User completes a %s','buddypress-learndash'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?><br>
					<input type="checkbox" name="user_quiz_pass" value="true" <?php echo $this->bp_is_checked( 'user_quiz_pass', $bp_learndash_course_activity ); ?> ><?php printf( __('User passes a %s','buddypress-learndash'), LearnDash_Custom_Label::label_to_lower( 'course' ) ); ?><br>
					<input type="checkbox" name="user_lesson_comment" value="true" <?php echo $this->bp_is_checked( 'user_topic_comment', $bp_learndash_course_activity ); ?> ><?php printf( __('User comments on single %s page','buddypress-learndash'), LearnDash_Custom_Label::label_to_lower( 'topic' ) ); ?><br>
