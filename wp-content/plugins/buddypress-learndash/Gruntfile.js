...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'buddypress-learndash', 'buddypress', 'bbpress', 'buddypress-inbox', 'wcvendors-pro', 'woocommerce' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'buddypress-learndash.pot', // Name of the POT file.
