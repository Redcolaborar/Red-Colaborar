...
class AwstAjax {
    ...
    function awst_ajax_like(){
        ...
        if ( is_user_logged_in() ) {
            ...
            // $totalLiked  = AwstHelper::count_object_likes( $postmeta );
            // $isLiked    =   AwstHelper::has_user_liked_object( $user_ID, $post->ID, 'post' );

            AwstHelper::toggle_user_like_for_object( $user_id, $object_id, $object_type );
            $liked = AwstHelper::has_user_liked_object( $user_id, $object_id, $object_type );

            $totalLiked =   AwstHelper::count_object_likes( $object_id, $object_type );
