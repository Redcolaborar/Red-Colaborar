...
class WpProQuiz_Controller_Admin {
	...
	public function register_page() {
		/*$page = add_menu_page(
					...
					'ldAdvQuiz',
					array($this, 'route'));*/
	    $page = add_submenu_page("learndash-lms-non-existant", sprintf( _x('Advanced %s', 'Advanced %s', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ) ), sprintf( _x('Advanced %s', 'Advanced Quiz', 'wp-pro-quiz'), LearnDash_Custom_Label::get_label( 'quiz' ) ), "wpProQuiz_show", "ldAdvQuiz", array($this, 'route'));
