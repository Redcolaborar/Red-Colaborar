...
function mpp_setup_core() {
	...
	// custom register embed type //alw start
	mpp_register_type( array(
            'key'           => 'embedded',
            'label'         => __( 'Embedded', 'mediapress' ),
			'labels'		=> array(
								'singular_name'	=> __( 'Embedded', 'mediapress' ),
								'plural_name'	=> __( 'Embeddeds', 'mediapress' )
			),
            'description'   => __( 'This is embedded gallery', 'mediapress' )
            //'extensions'    => array( '')
    	) );
	//alw end
