...
function mpp_activity_update_attached_media_ids( $activity_id, $media_ids ) {
	...
	error_log( "mpp_activity_update_attached_media_ids (30): " . var_export( debug_backtrace(), 1 ) . "\n", 3, WP_CONTENT_DIR . "/debug.log" );
...
function mpp_activity_mark_attached_media( $activity_id ) {
	...
	// error_log( "mpp_activity_mark_attached_media (221):" . var_export( $media_ids, 1 ) . "\n", 3, WP_CONTENT_DIR . "/debug.log" );

	$media_ids = array_filter( array_unique( $media_ids ) );

	// error_log( "mpp_activity_mark_attached_media (225):" . var_export( $media_ids, 1 ) . "\n", 3, WP_CONTENT_DIR . "/debug.log" );
