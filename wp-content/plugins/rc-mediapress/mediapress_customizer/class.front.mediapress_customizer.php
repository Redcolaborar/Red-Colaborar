...
<a href="../mediapress/mediapress.php"></a>
        ...
        function red_mpp_activity_upload_buttons()
        {
            ...
            <?php do_action( "mpp_before_activity_upload_buttons" ); //allow to add more type  ?>
                    ...
                    <?php endif; ?>
                    <a style="" href="#" id="mpp-all-upload"  data-media-type="all"><img title="<?php echo __("Upload File", 'mediapress-customizer')?>" src="<?php echo mpp_get_asset_url( 'assets/images/media-button-doc.gif', 'media-doc-icon' ); ?>" /></a>
...
//            }
            ...
            if(count($posts_array) > 0)
            {
                ...
                $html .='<div class="assign_gallery_container"><div class="assign_laggery_label">'.__("Assign Gallery", 'mediapress-customizer').'</div><div class="galley_selection"><select class="form-control" name="mpp_galler_data" id="mpp_gallery_assignment" onchange="getSelectedGallery(this);">';
                foreach($posts_array as $post_data)
                {
                    ...
                    // {
                        ...
                        if( strtolower($post_data->post_title) != "recursos" ) continue;
                ...
                {
                    echo $html = '<div class="gallery_title_text"><div class="new_gallery_label">Nombre de la carpeta</div><div class="gallery_title_input"><input class="form-control" type="text" placeholder="Escribir nombre" name="gallery_title_text_first_time" id="gallery_title_text_id">'.$append_html.'</div></div>';
                }
            }
            else{
                echo $html = '<div class="gallery_title_text"><div class="new_gallery_label">Nombre de la carpeta</div><div class="gallery_title_input"><input class="form-control" type="text" placeholder="Escribir nombre" name="gallery_title_text_first_time" id="gallery_title_text_id">'.$append_html.'</div></div>';
