...
function getSelectedGallery(id_data)
{
    ...
    {
        var text_title = '<div class="gallery_title_text"><div class="new_gallery_label">Nombre de la carpeta</div><div class="gallery_title_input"><input class="form-control" type="text" id="gallery_title_text_id" name="gallery_title_text" placeholder="Nombre de la carpeta"></div></div>';
...
//                        '<select class="mpp-media-associated-tags-class" data-placeholder="Seleccionar Etiquetas..." multiple style="width:350px;" tabindex="4" name="mpp-media-tags-embedded[]">'+get_tags_dropdown_data+'</select>'+

                    '<input id="add_tags_with_media_0" type="text" placeholder="Seleccionar Etiquetas..." name="mpp-media-tags-embedded[]" class="demo-default input-tags-for-media" value='+get_tags_dropdown_data+'>'+
                    '</div>'+
                '</div>'+
            '</div>';
    ...
    jQuery(addButton).click(function(){
        if(x < maxField){ //Check maximum number of input fields
            ...
            var fieldHTML = '<div class="red_enter_video_link_container">'+
                       ...
                       '<div class="tags_for_mediapress_customizer">'+
//                         '<select class="mpp-media-associated-tags-class" data-placeholder="Seleccionar Etiquetas..." multiple style="width:350px;" tabindex="4" name="mpp-media-tags-embedded[]">'+get_tags_dropdown_data+'</select>'+
                       '<input type="text" id='+id_for_tags+' placeholder="Seleccionar Etiquetas..."  name="mpp-media-tags-embedded[]" class="demo-default input-tags-for-media" value='+get_tags_dropdown_data+'>'+
                   '</div>'+
                   '</div>';
