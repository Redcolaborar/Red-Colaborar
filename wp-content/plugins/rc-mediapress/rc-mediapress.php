...
/**
 * Plugin Name: Media Control for RedColaborar
 * Version: 1.0.0
 * Description: Plugin created on top of Mediapress 1.0.9 to suit the needs of Redcolaborar.org. Includes Mediapress Customizer 1.0.0 and Buddypress Edit Activity 1.0.0.
...
require_once( __DIR__ . '/mediapress_customizer/mediapress_customizer.php' );
require_once( __DIR__ . '/buddypress-edit-activity-mediapress/buddypress-edit-activity-mediapress.php' );
