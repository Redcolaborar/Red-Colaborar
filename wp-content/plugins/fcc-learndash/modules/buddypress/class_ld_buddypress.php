...
class Wdm_ld_buddypress
{
    public function __construct()
    {
        ...
        add_filter('login_redirect', array($this, 'wdm_bpdev_redirect_to_profile'), 10, 3);
            ...
            add_action('bp_setup_nav', array($this, 'wdm_lnlb_profile_new_nav_question'), 15);
    ...
    public function wdm_lnlb_profile_new_nav_item()
    {
        ...
        if ($get_data_from_db == 'available' && is_user_logged_in()) {
            global $bp;
            global $current_user;
            $displayed_user = '';
            $logged_in_user = '';
            $yes_or_no = false;
            if (isset($bp->displayed_user->id) && isset($bp->loggedin_user->id)) {
            ...
            if ($displayed_user == $logged_in_user && $yes_or_no) {
