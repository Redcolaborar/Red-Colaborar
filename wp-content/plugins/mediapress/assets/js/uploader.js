...
(function( exports, $ ) {
	...
	$.extend( Uploader.prototype, {
        ...
        uploaded_media_list_for_customizer : _.template ( "<div class='mpp-uploaded-media-item red_mapp_upload_items' id='mpp-uploaded-media-item-<%= id %>' data-media-id='<%= id %>'><a href='#' class='mpp-delete-uploaded-media-item'>x</a><img src='<%= url %>' /><div><select name='mpp-media-status[<%= id %>]'><%= get_status_data %></select></div><div><input placeholder='Enter File Title' value='<%= title %>' type='text' name='mpp-media-title[<%= id %>]'></div><div class='tags_for_mediapress_customizer'><input type='text' id='mpp-media-associated-tags<%= id %>' name='mpp-media-associated-tags[<%= id %>]' placeholder='Choose a Tags...' class='demo-default input-tags-for-media ABC' data-custom_data='efgh' value='<%= post_tags_for_media %>'</div></div>" ),
