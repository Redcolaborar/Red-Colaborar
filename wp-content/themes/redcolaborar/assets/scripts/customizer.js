...
( function( window, $, app ) {
	...
	app.cache = function() {
		app.$c = {
			window: $( window ),
			headerButtonSelect: $( '#customize-control-wds_redcolaborar_header_button select' ),
			headerLinkButton: $( '#customize-control-wds_redcolaborar_header_button_url' ),
			headerLinkText: $( '#customize-control-wds_redcolaborar_header_button_text' )
		};
	};
