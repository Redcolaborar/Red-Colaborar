...
[`redcolaborar_display_svg( $args = array() ); // Return SVG markup`](../../blob/master/inc/template-tags.php#L125)
```
/**
 * Return SVG markup.
 *
...
Example usage:
`<?php echo redcolaborar_display_svg( array( 'icon' => 'twitter' ) ); ?>`
...
```
[`redcolaborar_do_svg( array( 'icon' => $icon_name ) ); // Echo SVG markup`](../blob/master/inc/template-tags.php#L139)

Example usage:
`<?php redcolaborar_do_svg( array( 'icon' => 'facebook' ) ); ?>`
