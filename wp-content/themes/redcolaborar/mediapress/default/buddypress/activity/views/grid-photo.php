            ...
            $post_type = get_post_type($embeded_data_id);
				...
				// embed video will not display by this template
				 ...
				 //if($content_post_mime_type == 'image/png' || $content_post_mime_type == 'image/jpeg'|| $content_post_mime_type == 'image/jpg'|| $content_post_mime_type == 'image/gif'){
					...
					?>
								<div class="mpp-media-holder" data-rc-media-type='image' data-mpp-gallery-id="<?php echo $gallery_id ?>" data-mpp-activity-id="<?php echo $activity_id;?>" <?php if( (2 < $i) && !bp_is_single_activity() ) echo 'style="display:none"' ?>>
								...
								<?php if( (3 == $i)  && !bp_is_single_activity() ) : ?>
									<a href="javascript:void(0)" class="rc-link-view-more-media" data-media-type='image' data-activity-id="<?php echo $activity_id;?>">Ver más Imágenes</a>
								<?php endif; ?>
