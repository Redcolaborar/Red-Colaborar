 ...
 */
function wds_redcolaborar_include_custom_controls() {
...
add_action( 'customize_register', 'wds_redcolaborar_include_custom_controls', -999 );

/**
 * Enqueue customizer related scripts.
 */
function wds_redcolaborar_customize_scripts() {
	wp_enqueue_script( 'redcolaborar-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', array( 'jquery', 'customize-preview' ), '1.0.0', true );
}
add_action( 'customize_preview_init', 'wds_redcolaborar_customize_scripts' );
 ...
 */
function wds_redcolaborar_selective_refresh_support( $wp_customize ) {

	// The <div> classname to append edit icon too.
	$settings = array(
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'wds_redcolaborar_copyright_text' => '.site-info',
	);
...
add_action( 'customize_register', 'wds_redcolaborar_selective_refresh_support' );
 ...
 */
function wds_redcolaborar_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'wds_redcolaborar_live_preview_support', 999 );
