 ...
 */
function wds_redcolaborar_display_scaffolding_section( $args = array() ) {
	...
	$allowed_tags = wds_redcolaborar_scaffolding_allowed_html();
	...
	<div class="scaffolding-document <?php echo esc_attr( $class ); ?>">
		...
		<header class="scaffolding-document-header">
			...
			<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'redcolaborar' ); ?></button>
		...
		<div class="scaffolding-document-content">
			...
			<?php if ( $args['description'] ) : ?>
				<p><strong><?php esc_html_e( 'Description', 'redcolaborar' ); ?>:</strong></p>
				<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
			<?php endif; ?>

			<?php if ( $args['parameters'] ) : ?>
				<p><strong><?php esc_html_e( 'Parameters', 'redcolaborar' ); ?>:</strong></p>
			...
			<?php if ( $args['arguments'] ) : ?>
				<p><strong><?php esc_html_e( 'Arguments', 'redcolaborar' ); ?>:</strong></p>
			...
			<?php if ( $args['usage'] ) : ?>
				<p><strong><?php esc_html_e( 'Usage', 'redcolaborar' ); ?>:</strong></p>
				<pre><?php echo esc_html( $args['usage'] ); ?></pre>
			<?php endif; ?>

			<?php if ( $args['output'] ) : ?>
				<p><strong><?php esc_html_e( 'HTML Output', 'redcolaborar' ); ?>:</strong></p>
 ...
 * @author Carrie Forde
 */
function wds_redcolaborar_scaffolding_allowed_html() {
 ...
 * @author Carrie Forde
 */
function wds_redcolaborar_display_global_scaffolding_section( $args = array() ) {
 ...
 * @author Carrie Forde
 */
function wds_redcolaborar_hook_theme_scaffolding() {
...
add_action( 'wds_redcolaborar_scaffolding_content', 'wds_redcolaborar_hook_theme_scaffolding' );