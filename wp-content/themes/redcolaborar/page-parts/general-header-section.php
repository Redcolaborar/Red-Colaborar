...
$primary_menu = wp_nav_menu( array(
        ...
        'menu_class'        => 'nav navbar-nav redcolaborar-navbar',
...
<div id="header" class="header-color">
	...
	<div class="navbar" role="navigation">
		...
		?>
		<div class="recolabarar-main-navigation kleo-main-header <?php echo $header_class; ?>">
			<div class="container">
				<!-- Brand and toggle get grouped for better mobile display -->
				<div class="navbar-header redcolaborar-logo">
					<div class="kleo-mobile-switch">
						...
						<button type="button" <?php echo $mobile_menu_atts; ?>>
							<span class="sr-only"><?php esc_html_e( 'Toggle navigation', 'redcolaborar' ); ?></span>
