...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" class="under_theme" name="whats-new-form" role="complementary">
	...
	<div id="whats-new-content">
		...
		<div id="whats-new-options">
          ...
          <div id="whats-new-post-in-box">
					...
					?></label>
<!--					<select id="whats-new-post-in" class="whats-new-post-in-red-choosen-data" style="width:350px;" multiple="" tabindex="3" name="whats-new-post-in">-->
                                            <select id="whats-new-post-in" class="whats-new-post-in-red-choosen-data-exot" style="width:350px;" abindex="3" name="whats-new-post-in">
